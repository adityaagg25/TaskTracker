...
export default function Header() {
  ...
  return (
    <header className="bg-white/70 backdrop-blur-md border-b border-gray-200 sticky top-0 z-40 dark:bg-gray-800/70 dark:border-gray-700">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2 sm:hidden">
            ...
            <button
              ...
              className="p-2 rounded-lg bg-transparent hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 transition-colors"
      ...
      {menuOpen && (
        <div className="sm:hidden absolute top-16 right-1 z-50">
          <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-lg w-50 mr-1 rounded-lg py-6 px-5 flex flex-col items-end space-y-4">
            <div className="flex items-center space-x-2 text-sm text-gray-700 dark:text-gray-300 justify-end w-full">
              <User className="h-4 w-4" />:
              <span>{user?.email}</span>
            </div>
            ...
            <button
              onClick={logout}
              className="inline-flex items-center px-3 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-600  self-end justify-center"
            >
              <LogOut className="h-4 w-4 mr-2" />
              Sign out
            </button>
